...
interface RecruiterDocumentsClientProps {
  user: User;
}

export default function RecruiterDocumentsClient({
  user,
}: RecruiterDocumentsClientProps) {
  const {
    data: documentsData,
    isLoading,
    error,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          View and manage all your AI-generated CV documents
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your recently generated CV documents
          </CardDescription>
        </CardHeader>
        <CardContent>
          {allDocs.length > 0 ? (
