...
export function CandidateGuidanceClient() {
  ...
  const getFieldData = () => {
    ...
    return candidateGuidance.fields[user.field as keyof typeof candidateGuidance.fields];
  };

  const getCareerStageData = () => {
    if (!user?.careerStage) return null;
    return candidateGuidance.careerStages[user.careerStage as keyof typeof candidateGuidance.careerStages];
  };
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Personalized insights and strategies to accelerate your career growth in {fieldData?.label}
        </p>
      </motion.div>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="h-full border-l-4 border-l-blue-500">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {candidateGuidance.generalTips.cvOptimization.slice(0, 4).map((tip, index) => (
            ...
            >
              <Card className="h-full border-l-4 border-l-green-500">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {candidateGuidance.generalTips.interviewPreparation.slice(0, 4).map((tip, index) => (
                      <div key={index} className="flex items-start gap-2 text-sm">
            ...
            >
              <Card className="h-full border-l-4 border-l-purple-500">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {candidateGuidance.generalTips.jobSearch.slice(0, 4).map((tip, index) => (
                      <div key={index} className="flex items-start gap-2 text-sm">
            ...
            <>
              ...
              {specializationData && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {specializationData && 'tips' in specializationData && (specializationData as SpecializationData).tips && (
                    <motion.div
                    ...
                    >
                      <Card>
                        ...
                        <CardContent>
                          <div className="space-y-3">
                            {(specializationData as SpecializationData).tips!.map((tip: string, index: number) => (
                  ...
                  {specializationData && 'keywords' in specializationData && (specializationData as SpecializationData).keywords && (
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="flex flex-wrap gap-2">
                            {(specializationData as SpecializationData).keywords!.map((keyword: string, index: number) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  <Card className="h-full">
                    <CardHeader>
                      <CardTitle className="text-red-700 dark:text-red-300">Common Challenges</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                ...
                >
                  <Card className="h-full">
                    <CardHeader>
                      <CardTitle className="text-green-700 dark:text-green-300">Success Strategies</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
        ...
        <TabsContent value="tools" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.entries(candidateGuidance.aiToolsInfo).map(([key, tool], index) => (
              <motion.div
                key={key}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
