      ...
      <div className="mt-16 px-4 md:px-6">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-2">
            ...
            <p className="mx-auto mb-4 pb-2.5 max-w-[700px] text-muted-foreground">
...
function Cta() {
  return (
    <section className="py-10 md:py-20">
      <section className="flex justify-center bg-gradient-to-r from-blue-500 to-blue-700 py-10 md:py-20 rounded-lg">
