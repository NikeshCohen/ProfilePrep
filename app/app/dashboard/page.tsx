...
export default async function DashboardPage() {
  const { user } = await requireAuth("/app/dashboard");
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-2 rounded-full bg-muted">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, (stats.totalDocs / 1000) * 100)}%`,
                          }}
                        />
                      </div>
                      <p className="text-xs text-muted-foreground">
                        {1000 - stats.totalDocs} documents remaining until next
                        tier
                      </p>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-2 rounded-full bg-muted">
                        <div
                          className="h-full rounded-full bg-primary"
                          style={{
                            width: `${Math.min(100, (stats.totalTemplates / 50) * 100)}%`,
                          }}
                        />
                      </div>
                      <p className="text-xs text-muted-foreground">
                        {50 - stats.totalTemplates} templates remaining until
                        next tier
                      </p>
                    </div>
        ...
        {user.role === "USER" && (
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
            ...
            <Button asChild className="mt-2 w-full">
              <Link href="/app/settings">View Limits</Link>
            </Button>
