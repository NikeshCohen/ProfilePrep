...
export default async function AnalyticsPage() {
  const { user } = await requireAuth("/app/dashboard/analytics");
                  ...
                  <div key={index} className="space-y-2">
                    ...
                    <div className="h-2 rounded-full bg-muted">
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, (company.count / (analytics.topCompanies[0]?.count || 1)) * 100)}%`,
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div key={activeUser.id} className="space-y-2">
                    ...
                    <div className="h-2 rounded-full bg-muted">
                      <div
                        className="h-full rounded-full bg-primary"
                        style={{
                          width: `${Math.min(100, (activeUser.createdDocs / activeUser.allowedDocs) * 100)}%`,
                        }}
                      />
                    </div>
                  </div>
